...
integer, parameter, public :: maxpft = 16      ! maximum number of PFTs allowed
   ...
   character(len=param_string_length),parameter,public :: fates_name_crown_fire_switch = "fates_crown_fire_switch"
...
contains
  ...
  subroutine FatesReportParams(is_master)
     ...
     if(debug_report .and. is_master) then
        ...
        write(fates_log(),fmt0) 'crown_fire_switch = ',crown_fire_switch
